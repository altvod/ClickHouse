...
void ReplicatedMergeTreePartCheckThread::checkPart(const String & part_name)
{
    ...
    else if (part->name == part_name)
    {
        ...
        if (zookeeper->tryGet(storage.replica_path + "/parts/" + part_name, part_znode))
        {
            ...
            try
            {
                ...
                {
                    String columns_znode = zookeeper->get(storage.replica_path + "/parts/" + part_name + "/columns");
                    String checksums_znode = zookeeper->get(storage.replica_path + "/parts/" + part_name + "/checksums");
